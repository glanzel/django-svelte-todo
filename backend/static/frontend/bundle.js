    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 6, 14, 86);
    			add_location(p, file, 6, 1, 73);
    			if (!src_url_equal(img.src, img_src_value = "vite.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "haha");
    			add_location(img, file, 7, 1, 184);
